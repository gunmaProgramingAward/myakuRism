...
class SettingUseCaseImpl @Inject constructor(
    ...
    override suspend fun updateSetting(selectType: SettingType, value: Int) =
        repository.updateSettingState(selectType, value)
    override suspend fun updateBirthdate(selectType: SettingType, year: Int, month: Int, day: Int) =
        repository.updateSettingState(selectType, year, month, day)
